...
import { useRegisterUserMutation } from "../store/features/user/api/userApiSlice";
    ...
    <div className="h-screen overflow-y-auto bg-[#121212] text-white">
      <div className="mx-auto my-8 flex w-full max-w-sm flex-col px-4">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <button
            type="submit"
            className="bg-[#ae7aff] px-4 py-3 text-black w-full"
          >
            {isLoading ? (
              <ThreeDots
                visible={true}
          ...
          <p className="text-sm mt-3 text-center">
            ...
            <Link className="text-[#ae7aff] underline" to="/login">
              Login Here
            </Link>
          </p>
        </form>
